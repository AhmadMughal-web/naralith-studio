                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-10">
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="mt-4 max-w-2xl text-base leading-relaxed text-body sm:text-lg">
                            Every question that goes unanswered after hours is a missed sale or a frustrated customer. 
                            We build AI chatbots trained on your actual business — products, policies, and tone — so 
                            customers get real answers immediately.
                        </p>
